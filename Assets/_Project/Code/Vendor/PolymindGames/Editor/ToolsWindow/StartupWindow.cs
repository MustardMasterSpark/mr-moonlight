...
namespace PolymindGames.Editor
{
    ...
    public sealed class StartupWindow : EditorWindow
    {
        ...
        // MRM-9: the vendor auto-opened this welcome window on every domain reload. Mr. Moonlight
        // doesn't ship vendor onboarding UI, and its banner art was never imported, so it opened
        // blank. The window itself stays reachable from Tools > Polymind Games > Startup; only the
        // auto-open hook is removed.
