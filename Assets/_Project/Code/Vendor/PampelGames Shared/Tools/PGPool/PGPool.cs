    ...
    public static class PGPool
    {
        ...
        private class PoolDescr
        {
            public PoolDescr(GameObject prefab, ObjectPool<GameObject> pool)
            {
                ...
                poolDictionary.Add(PGObjectUtility.GetObjectID(prefab), this);
            }
        ...
        {
            return poolDictionary.TryGetValue(PGObjectUtility.GetObjectID(prefab), out var poolsStruct) ? poolsStruct.pool : null;
        }
        ...
        {
            if (!poolDictionary.TryGetValue(PGObjectUtility.GetObjectID(prefab), out var poolDescr)) poolDescr = new PoolDescr(prefab, _pool);
        ...
        {
            if (!poolDictionary.TryGetValue(PGObjectUtility.GetObjectID(prefab), out var poolDescr))
            {
        ...
        public static void Release(GameObject obj)
        {
            ...
            if (!poolDictionary.TryGetValue(PGObjectUtility.GetObjectID(pgPoolables[0].prefab), out var foundPoolStruct))
            {
        ...
        {
            return poolDictionary.TryGetValue(PGObjectUtility.GetObjectID(prefab), out var foundPoolStruct) ? foundPoolStruct.pool.CountActive : 0;
        }

        public static int GetCountInactive(GameObject prefab)
        {
            return poolDictionary.TryGetValue(PGObjectUtility.GetObjectID(prefab), out var foundPoolStruct) ? foundPoolStruct.pool.CountInactive : 0;
        }
