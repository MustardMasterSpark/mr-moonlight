...
namespace BlazeAISpace
{
    ...
    public class AttackStateBehaviourInspector : Editor
    {
        ...
        autoSetNavmeshSamplingRadius,
        navmeshSamplingRadius,
        ...
        void OnEnable()
        {
            ...
            avoidChase = serializedObject.FindProperty("avoidChase");
            targetLocationUpdateTime = serializedObject.FindProperty("targetLocationUpdateTime");

            autoSetNavmeshSamplingRadius = serializedObject.FindProperty("autoSetNavmeshSamplingRadius");
            navmeshSamplingRadius = serializedObject.FindProperty("navmeshSamplingRadius");
            ...
            distanceTolerance = serializedObject.FindProperty("distanceTolerance");
        ...
        void DrawGeneralTab(AttackStateBehaviour script)
        {
            ...
            GUILayout.BeginVertical(BlazeAIEditor.BlockStyle());
                ...
                EditorGUILayout.PropertyField(avoidChase);
                if (!script.avoidChase) {
                    EditorGUILayout.PropertyField(targetLocationUpdateTime);
                }
                
                EditorGUILayout.PropertyField(autoSetNavmeshSamplingRadius);
                if (!script.autoSetNavmeshSamplingRadius)
                {
                    EditorGUILayout.PropertyField(navmeshSamplingRadius);
                }
            GUILayout.EndVertical();
        ...
        void DrawAttackTab(AttackStateBehaviour script)
        {
            ...
            GUILayout.BeginVertical(BlazeAIEditor.BlockStyle());
                ...
                EditorGUILayout.PropertyField(distanceTolerance);
            GUILayout.EndVertical();
        ...
        void DrawAttackIdleTab(AttackStateBehaviour script)
        {
            GUILayout.BeginVertical(BlazeAIEditor.BlockStyle());
                ...
                {
                    EditorGUILayout.Space();
                    EditorGUILayout.LabelField("Move Backwards Distance clamped to be smaller than Distance From Enemy in Attack tab.", BlazeAIEditor.BoxStyle());
                    EditorGUILayout.Space();
            ...
            GUILayout.BeginVertical(BlazeAIEditor.BlockStyle());
                ...
                if (script.turnToTarget) 
                {
                    ...
                    {
                        EditorGUILayout.Space();
                        EditorGUILayout.LabelField("Turn animations set in Blaze AI > General tab > Waypoints sub-tab > Turning Section", BlazeAIEditor.BoxStyle());
                        EditorGUILayout.Space();
                    }
        ...
        {
            if (script.blaze.companionMode)
            {
                EditorGUILayout.LabelField("AI in companion mode can't search. It'll automatically return to following the player when no enemies are found.", BlazeAIEditor.BoxStyle());
                return;
            }
            ...
            GUILayout.BeginVertical(BlazeAIEditor.BlockStyle());
                ...
                if (script.searchLocationRadius)
                {
                    ...
                    EditorGUILayout.PropertyField(showSearchRadius);
                    EditorGUILayout.Space();
