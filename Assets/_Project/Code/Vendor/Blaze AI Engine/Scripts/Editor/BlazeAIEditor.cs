...
public class BlazeAIEditor : Editor
{
        ...
        GUILayout.BeginVertical(BlockStyle());
            ...
            EditorGUI.BeginDisabledGroup(script.waypoints.loop);
                ...
                if (script.waypoints.randomize)
                {
                    ...
                    EditorGUILayout.PropertyField(preventPointsBehindObstacles);
    ...
    {
        GUILayout.BeginVertical(BlockStyle());
            EditorGUILayout.LabelField("Set Obstacle Layers Only", EditorStyles.boldLabel);
        ...
        DrawArrayWithStyle(hostileTags, "Enemy Tag Names", true);
    ...
    void GetWaypointsProperties()
    {
        ...
        preventPointsBehindObstacles = waypointsProp.FindPropertyRelative("preventPointsBehindObstacles");
