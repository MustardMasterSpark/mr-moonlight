    ...
    public class AlertTagBehaviour : BlazeBehaviour
    {
        ...
        public virtual void CallAgents()
        {
            ...
            for (int i=0; i<agentsNum; i++)
            {
                ...
                if (callOthersHitArr[i].transform.root == transform.root) continue;
                ...
                if (!callPassesColliders) 
                {
                    ...
                    Collider targetColl = callOthersHitArr[i];
                    ...
                    Vector3 otherAgentCenter = targetColl.ClosestPoint(currentCenter);
                    ...
                    {
                        if (!rayHit.transform.root != target.root) 
                        {
                            shouldCallPass = false;
                            continue;
                        }
                    }
                }
