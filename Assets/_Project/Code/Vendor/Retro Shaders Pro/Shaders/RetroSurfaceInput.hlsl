...
float _Cutoff;
// Wind sway (MRM-18, reusable beyond the main menu - see RetroWind.hlsl and
// Docs/retrolit-wind-sway.md). Off by default, so every material that never opts in renders
// exactly as before.
float _WindEnabled;
float _WindCategory;
float _WindHeight;
